		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Gizem",
									"targetURL": "#ntttestgizemui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ntttestgizemui-display": {
								"semanticObject": "ntttestgizemui",
								"action": "display",
								"description": "Gizem",
								"title": "Gizem",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ntt.test.gizemui",
									"url": sap.ui.require.toUrl("ntt/test/gizemui")
								}
							}
						}
					}
