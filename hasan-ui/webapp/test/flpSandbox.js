		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Hasan",
									"targetURL": "#ntttesthasanui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ntttesthasanui-display": {
								"semanticObject": "ntttesthasanui",
								"action": "display",
								"description": "Hasan",
								"title": "Hasan",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ntt.test.hasanui",
									"url": sap.ui.require.toUrl("ntt/test/hasanui")
								}
							}
						}
					}
